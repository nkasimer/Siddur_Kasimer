...
Min\d{h}a, the afternoon prayer, is contained in selections from sha\d{h}ari\thav\space as follows:\begin{itemize}
	\item Some say recite the verses regarding the Tamid on page \pageref{korbanos}.
	\item Ashrei is on page \pageref{PDZashrei}.
	\item The reader recites Half Kaddish on page \pageref{shacharitchatzikaddish}.
	\item On fast days the Torah and Haftara are chanted.  The Torah service is on page \pageref{weekday torah}. The readings are on page \pageref{torah taanis tzibbur}. The Torah service is followed by the reader reciting Half Kaddish on page \pageref{shacharitchatzikaddish}.
	\item The amida is recited silently, and repeated by the reader, on page \pageref{amidahshacharitchol}.
	\item On fast days and the Ten Penitential Days Avinu Malkeinu is read on page \pageref{avinu malkeinu}.
